...
def GET_EVENTOS_PRICELESS_KPIS():
	...
	SELECT 
		...
		tep.VALOR_LOCACAO_AROO_1 + tep.VALOR_LOCACAO_AROO_2 + tep.VALOR_LOCACAO_AROO_3 + tep.VALOR_LOCACAO_ANEXO + tep.VALOR_LOCACAO_NOTIE + tep.VALOR_LOCACAO_MIRANTE AS 'Valor Locacao Total',
