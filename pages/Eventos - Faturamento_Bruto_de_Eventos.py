...
def main():
	...
	with col1:
		st.title("💰 Faturamento Bruto de Eventos")
	with col2:
	...
	with col1:
		lista_retirar_casas = ['Bar Léo - Vila Madalena', 'Blue Note SP (Novo)', 'Edificio Rolim', 'Terraço Notie', 'Escritório Fabrica de Bares', 'The Cavern - Almoço', 'Sanduiche comunicação LTDA ', 'Tempus Fugit  Ltda ', 'Terraço Notie Novo']
